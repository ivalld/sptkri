                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="pencarian" id="pencarian" class="form-control ukuran_font" placeholder="Jenis dokumen ...">
                            </div>
                        </div>
                        <div class="col-md-6" style="margin-top: 16px">
                            <a class="btn btn-block bg-gradient-info btn-sm float-right mt-4" style="width: 230px;" href="{{route('create_jenis_dokumen')}}"><i class="fa fa-plus"></i> Tambah Jenis Dokumen</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th style="padding-top:5px; padding-left:5px; padding-right:5px; padding-bottom:5px; font-size: 14px">Jenis Dokumen</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-sm">
                                            <a class="btn btn-block bg-gradient-secondary btn-sm" href="{{route('edit_jenis_dokumen',$item->id_dokumen)}}" title="Edit"><i class="fa fa-edit"></i></a>
                                        </div>
                                        <div class="col-sm">
                                            <a class="btn btn-block bg-gradient-danger btn-sm delete_peratawan" href="#" data-set="delete_peratawan" title="Delete" data-id="{{$item->id_dokumen}}"><i class="fa fa-cut"></i></a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="4" class="text-center">
                                    <p class="text-danger">Data jenis dokumen tidak ditemukan</p>
                                </td>
                            </tr>
                            @endif
                        </tbody>
...
<div class="modal fade text-left" id="hapus_data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel19" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('delete_jenis_dokumen')}}" method="POST">
                @csrf
                <div class="modal-body">
                    Apakah anda ingin menghapus data jenis dokumen ?
...
<script type="text/javascript">
    ...
    $("#pencarian").keyup(function() {
        $.ajax({
            ...
            type: "POST",
            url: "{{route('pencariaan_jenis_dokumen')}}",
            cache: false,
            datetype: "JSON",
            data: {
