    ...
    <div class="col-md-6 mt-4">
        <div class="card card-outline card-info">
            ...
            <div class="card-body pad">
                <form method="POST" action="{{route('save_jenis_dokumen')}}">
                    @csrf
                    <div class="form-group">
                        <label class="ukuran_font" for="jenis_dokumen">Jenis Dokumen</label>
                        <input type="text" class="form-control ukuran_font" name="jenis_dokumen" id="jenis_dokumen">
                        <span class="text-danger">{{$errors->first('jenis_dokumen')}}</span>
                    </div>
                    <div class="form-group">
                        <label class="ukuran_font" for="kode_dokumen">Kode Dokumen</label>
                        <input type="text" class="form-control ukuran_font" name="kode_dokumen" id="kode_dokumen">
