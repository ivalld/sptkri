 ...
 <head>
     ...
     <title>Login - SPT KRI Sisinfolog Kolinlamil</title>
 ...
 <body class="hold-transition login-page" style="font-family: Quicksand;">
     <div class="login-box">
         <div class="login-logo">
             <img src="{{asset('assets/gambar/Kolinlamil.png')}}" alt="Logo TNI AL" style="width: 34%">
             <br>
             <a href="#"> <strong>Sistem Pemeliharaan Terencana KRI <br>Sisinfolog Kolinlamil</strong> </a>
         </div>
         <!-- /.login-logo -->
         <div class="card">
