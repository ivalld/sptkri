...
<div class="col-md-4">
    <div class="form-group">
        ...
        <select class="form-control ukuran_font select2" style="width: 100%;" name="id_periode" id="id_periode">
            ...
            <option value="{{$datas->keterangan}}">{{$datas->keterangan}}</option>
            @endforeach
        </select>
    ...
    <table class="table w-auto table-bordered table-hover table-striped">
        <thead>
            <tr>
                ...
                <th class="ukuran_font" style="text-align: center;padding-top: 5px; padding-bottom: 5px; padding-left: 5px;">KRI</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="ukuran_font accordion-toggle collapsed" id="accordion1" data-toggle="collapse" data-parent="#accordion1" href="#collapse{{$datas->id}}" width="250px;" style="text-align: center;padding-top: 5px; padding-bottom: 5px; padding-left: 5px; color: blue">
                    {{$datas->nama_kapal}}
                </td>

                <td class="ukuran_font accordion-toggle collapsed" id="accordion1" data-toggle="collapse" data-parent="#accordion1" href="#collapse{{$datas->id}}" width="250px;" style="text-align: center;padding-top: 5px; padding-bottom: 5px; padding-left: 5px; color: blue">
                    {{$datas->kode_pemeliharaan}}
                </td>

                <td class="ukuran_font" style="text-align: center;padding-top: 5px; padding-bottom: 5px; padding-left: 5px;">
                    @if ($count_data <1) <span class="text-success">{{$datas->komponen}}</span>
                        @else
                    ...
                    <div class="btn-group">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item ukuran_font" target="_blank" href="{{route('print_kartu_pemeliharaan',$datas->id)}}"><i class="fa fa-print mr-1"></i> Cetak</a>
                                @if ($count_data < 1) @if($datas->rumus > 0)
