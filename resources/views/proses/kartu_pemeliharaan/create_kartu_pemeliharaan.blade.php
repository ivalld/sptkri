                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control ukuran_font select2" name="kapal" id="kapal" style="width: 100%;">
                                    <option value=""></option>
                                    @foreach ($kapal as $datas)
                                    <option value="{{$datas->id_kapal}}">{{$datas->nama_kapal}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control ukuran_font select2" name="kode_pemeliharaan" id="kode_pemeliharaan" style="width: 100%;">
                                    <option value=""></option>
                                    @foreach ($kartu_pemeliharaan as $datas)
                                    <option value="{{$datas->id}}">{{$datas->kode_pemeliharaan}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="ukuran_font">Waktu <span class="text-danger">*</span></label>
